    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-cyber">
      <div className="w-full max-width-sm glass-card p-8 rounded-2xl border border-border/60">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-xl font-semibold text-foreground">Sign in to NetraGuard</h1>
            <p className="text-sm text-muted-foreground">Secure your APIs with continuous discovery</p>
          </div>
        </div>
